...
public class ParameterAntOptimization {
    ...
    public static void createParameterAntOptimization(String fileName) throws IOException {
        ...
        calculationProbabityTransitionInColony();
    }
    ...
    public static void calculationChangePferomoneOnWay(){
    ...
    public static void calculationProbabityTransitionInColony() {
